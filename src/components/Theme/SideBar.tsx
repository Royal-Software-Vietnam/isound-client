...
export default function SideBar() {
    return <div className="container hidden lg:block w-[16%] bg-[#161616] relative">
            ...
            <div className="absolute bottom-28 pl-[20%] pt-5 w-full flex items-center border-t-[2px] border-[#111111] opacity-80 hover:opacity-100 hover:text-[#E9003F] hover:cursor-pointer">
